...
1.Class Members (Methods, Properties, etc.): 
By default, members of a class (such as methods and properties) are private if no access modifier is explicitly specified. 
